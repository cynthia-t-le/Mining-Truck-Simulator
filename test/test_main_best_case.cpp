...
// cd test
// g++ .\test_main_best_case.cpp ..\Simulator.cpp ..\Truck.cpp ..\Site.cpp -o Unit_Test_Best_Case -std=c++20 -pthread
// .\Unit_Test.exe

TEST_CASE("Mining Simulation for 3 trucks and 3 station.")
{
    int numTrucks = 3;
    int numStations = 3;
